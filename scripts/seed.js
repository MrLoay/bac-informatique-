    ...
    const sampleExams = [
      {
        ...
        year: 2023,
        session: 'principale',
        filename: 'math_2023_principale.pdf',
        is_available: true
      },
      {
        subject_id: 'math',
        year: 2023,
        session: 'controle',
        filename: 'math_2023_controle.pdf',
        is_available: true
      },
      {
        subject_id: 'programmation_theorique',
        year: 2023,
        session: 'principale',
        filename: 'programmation_theorique_2023_principale.pdf',
        is_available: true
      }
    ];
